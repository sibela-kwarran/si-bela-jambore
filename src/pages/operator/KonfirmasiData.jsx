...
export default function KonfirmasiData() {
  ...
  const [setuju, setSetuju] =
    useState(false);


  const [sudahKirim, setSudahKirim] =
    useState({
    ...
    try {
      ...
      if (
        ...
        setBerkas({
          ...
          suratTugas:
            dataBerkas[0].surat_tugas,

          suratIzin:
            dataBerkas[0].surat_izin,
